package com.david.MailTest.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("Mail Test API").description("API reference guide for developers").termsOfServiceUrl("https://www.google.com/").contact("David").version("1.0").build();
    }
}
